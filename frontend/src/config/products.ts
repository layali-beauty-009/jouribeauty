...
export const products: ProductConfig[] = [
  {
    ...
    rating: 4.9,
    reviewsCount: 284,
    badges: ["١٥ مل", "رولر بارد", "فيجان", "ضمان ٣٠ يوم"],
    ...
    testimonials: [
      ...
      {
        name: "دانة العنزي",
        meta: "٣٤ • أبوظبي • مشترية مؤكدة",
        initial: "د",
        text: "«أهم شي عندي التركيز مكتوب — ٥٪ كافيين مو كلمة “سيروم عين” فاضية. طلبت بـ COD ووصل خلال ٣ أيام.»",
        rating: 5,
      },
      {
        name: "هديل الزهراني",
        meta: "٤٠ • الشارقة • مشترية مؤكدة",
        initial: "ه",
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 312,
    badges: ["٣٠ مل", "شهر كامل", "فيجان", "ضمان ٣٠ يوم"],
    ...
    testimonials: [
      {
        name: "شما الخوري",
        meta: "٣٦ • دبي • مشترية مؤكدة",
        initial: "ش",
        text: "«الريتينول حرق وجهي قبل — الباكوتشيول هنا منطقي. بعد ٣ أسابيع بشرتي أنعم والخطوط الدقيقة أخف — خصوصاً مع شمس الإمارات والمكيف.»",
        rating: 5,
      },
      {
        name: "عائشة المنصوري",
        meta: "٤٢ • العين • مشترية مؤكدة",
        initial: "ع",
        text: "«أنا أقرأ المكوّنات دايم. ١.٣٪ باكوتشيول مكتوبة بوضوح — هالشي خلّاني أثق. الدفع عند الاستلام ريّحني من خوف السكام.»",
        rating: 5,
      },
      {
        name: "ريم السويدي",
        meta: "٣٣ • أبوظبي • مشترية مؤكدة",
        initial: "ر",
  ...
  },
  {
    ...
    mainIngredient: "ببتيد النحاس GHK-Cu",
    ingredientStack: [
      {
        name: "GHK-Cu",
    ...
    rating: 4.9,
    reviewsCount: 196,
    badges: ["٣٠ مل", "شهر كامل", "ببتيدات", "ضمان ٣٠ يوم"],
    offers: sharedOffers("٣٠ مل • شهر كامل"),
    upsell: {
      enabled: true,
      price: 199,
    ...
    testimonials: [
      ...
      {
        name: "حصة النعيمي",
        meta: "٣٩ • رأس الخيمة • مشترية مؤكدة",
        initial: "ح",
        text: "«جربت مرطبات كثيرة ما تثبت. GHK-Cu مع الإكتوين فرق معي — الحاجز صار أقوى وأقل حساسية.»",
        rating: 5,
      },
      {
        name: "مريم البلوشي",
        meta: "٤٣ • الفجيرة • مشترية مؤكدة",
        initial: "م",
