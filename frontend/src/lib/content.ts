      ...
      items: [
        {
          ...
          initial: "س",
          text: "«أنا أقرأ كل قائمة مكوّنات. جوري أول براند إماراتي يشرح ليش 5% كافيين للعين — مو مجرد كلمة “سيروم عين”. هذا وحده خلّاني أطلب بثقة.»",
          rating: 5,
        },
        {
          name: "نورة الكعبي",
        ...
        },
        {
          ...
          initial: "ف",
          text: "«سفر + شمس + تكييف = بشرتي كانت “مكسورة”. سيروم ببتيد النحاس رجّع راحة للحاجز — أقل احمرار وأقل شدّ بعد الاستمرار.»",
          rating: 5,
        },
      ],
    },
